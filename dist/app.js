...
app.directive('csLayout', ['$rootScope', function ($rootScope) {
  return {
    restrict: 'A',
...
homeModule.controller('skillController', ['$scope', 'homeService', function ($scope, homeService) {
  homeService.listSkill().then(function (res) {
    $scope.list = res.list;
  });
}]);

homeModule.controller('examineController', ['$scope', '$state', '$stateParams', '$timeout', 'homeService', function ($scope, $state, $stateParams, $timeout, homeService) {
...
homeModule.controller('salaryController', ['$scope', '$state', '$stateParams', function ($scope, $state, $stateParams) {
